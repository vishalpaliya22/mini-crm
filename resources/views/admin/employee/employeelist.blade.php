                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                    @foreach($employeeList as $emp)
                      <tr>
                        <input type="hidden" class="delete_id" value="{{$emp->id}}">
                        ...
                        <td> 
                            <a href="{{ route('employee.show', $emp->id) }}" class="btn btn-primary btn-sm"><i class="fa fa-fw fa-eye"></i></a> |
                            <a href="{{ route('employee.edit', $emp->id) }}" class="btn btn-warning btn-sm"><i class="fa fa-fw fa-edit"></i></a> | 
                            @csrf
