    ...
    <div class="card-body pt-0">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="symbol symbol-45 symbol-light mr-5">
                    <span class="symbol-label">
                        <img src="{{ asset('vendor/media/svg/misc/006-plurk.svg') }}" class="h-50 align-self-center" />
                    </span>
                </div>
        ...
        <div class="mb-10">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="symbol symbol-45 symbol-light mr-5">
                    <span class="symbol-label">
                        <img src="{{ asset('vendor/media/svg/misc/015-telegram.svg') }}" class="h-50 align-self-center" />
                    </span>
                </div>
        ...
        <div class="">
            ...
            <div class="d-flex align-items-center">
                ...
                <div class="symbol symbol-45 symbol-light mr-5">
                    <span class="symbol-label">
                        <img src="{{ asset('vendor/media/svg/misc/014-kickstarter.svg') }}" class="h-50 align-self-center" />
                    </span>
                </div>
